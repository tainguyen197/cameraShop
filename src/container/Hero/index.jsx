        ...
        <div className="wrap-slick1">
          <div className="slick1">
            <div
              ...
              style={{ backgroundImage: "url(images/master-slide-02.jpg)" }}
            >
            ...
            <div
              ...
              style={{ backgroundImage: "url(images/master-slide-03.jpg)" }}
            >
              <div className="wrap-content-slide1 sizefull flex-col-c-m p-l-15 p-r-15 p-t-150 p-b-170">
                <span
                  className="caption1-slide1 m-text1 t-center animated visible-false m-b-15"
            ...
            <div
              ...
              style={{ backgroundImage: "url(images/master-slide-04.jpg)" }}
            >
              <div className="wrap-content-slide1 sizefull flex-col-c-m p-l-15 p-r-15 p-t-150 p-b-170">
                <span
                  className="caption1-slide1 m-text1 t-center animated visible-false m-b-15"
